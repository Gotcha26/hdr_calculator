    ...
    <footer style={appStyles.footer}>
      <div style={appStyles.footerContainer}>
        <div style={appStyles.footerGrid}>
          ...
          <div>
            <h3 style={appStyles.footerTitle}>{t("Liens")}</h3>
            <ul style={{listStyle: 'none', padding: 0, fontSize: '0.75rem', color: '#94a3b8'}}>
              <li style={{marginBottom: '4px'}}>
                <a href="#faq" style={appStyles.footerLink}>{t("FAQ")}</a>
              </li>
              <li style={{marginBottom: '4px'}}>
                <a href="#github" style={appStyles.footerLink}>{t("GitHub")}</a>
              </li>
              <li>
                <a href="#support" style={appStyles.footerLink}>{t("Soutenir le projet")}</a>
              </li>
            </ul>
          </div>
          
          <div>
            <h3 style={appStyles.footerTitle}>{t("Informations")}</h3>
            <p style={appStyles.footerText}>
              {t("Créé avec ❤️ pour les photographes")}<br/>
        ...
        <div style={appStyles.footerCopyright}>
          © 2026 HDR Calculator • {t("Tous droits réservés")}
        </div>
      </div>
    </footer>
  );
