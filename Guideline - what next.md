...
├── data/
│   └── photoDatabase.js       # Base données photo (ISO, vitesses, ouvertures)
├── utils/
...
│   ├── RangePleine.jsx        # Calcul amplitude totale + aide décision
│   ├── SettingsPage.jsx       # Configuration matériel (boîtier/objectif)
...
- calculateCorrection1()        // Correction ISO
- calculateCorrection2()        // Correction Ouverture
- calculateRangePleine()        // Amplitude totale + suggestions
...
- 🟣 **Plage entière** (RangePleine.jsx)
- 🎨 **Paramètres artistiques** (dans SettingsPage.jsx)
- 📊 **Statistiques avancées** (durée détaillée, stop_sixth)
